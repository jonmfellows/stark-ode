...
class SchemeRK4:
    ...
    __slots__ = ("derivative", "k1", "k2", "k3", "k4", "parts", "stage", "trial")

    identity = SchemeIdentity("RK4", "Classical Runge-Kutta")
    tableau = RK4_TABLEAU
    ...
    def __init__(self, derivative: Derivative, workbench: Workbench) -> None:
        ...
        self.trial, self.k2, self.k3, self.k4 = parts.allocate_translation_buffers(4)
