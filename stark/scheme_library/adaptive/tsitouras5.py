...
class SchemeTsitouras5:
    ...
    __slots__ = ("controller", "derivative", "error", "k1", "k2", "k3", "k4", "k5", "k6", "k7", "parts", "stage", "trial")

    identity = SchemeIdentity("TSIT5", "Tsitouras 5")
    ...
    def __init__(
        ...
        self.trial, self.error, self.k2, self.k3, self.k4, self.k5, self.k6, self.k7 = parts.allocate_translation_buffers(8)
    ...
    def __call__(self, interval: IntervalLike, state: State, tolerance: Tolerance) -> float:
        ...
        combine6 = parts.combine6
        combine7 = parts.combine7
